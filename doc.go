...
// Package extauthsec is the cryptographic core of gloo-gateway-extauth-sec: a
...
// in their domain-specific claims. Supported are:
//
//   - Medewerkersportaal (internal use)
